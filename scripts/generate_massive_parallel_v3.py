...
SOURCE_VOCAB = {
    "det": [
        "te", "he", "tau", "nga", "na", "a", "o", "e", "ko", "ka", "teia", "tena",
        "taua", "tana", "taku", "ona", "aku", "tou", "kou", "mou", "tanaa", "takua",
        "te", "he", "na", "tau", "nga", "ko", "ka", "a", "o", "e", "teia", "tena",
    ],
    "noun": [
        "tangata", "vahine", "tamaiti", "ika", "manu", "rakau", "maa", "vai", "raa",
        ...
        "pepe", "moka", "uri", "kahu", "puku", "hue", "huea", "kore", "mate", "ora",
        "manava", "take", "roe", "tai", "au", "kopu", "reka", "hau", "titi", "kura",
        "paea", "tore", "here", "taki", "uru", "pua", "hue", "kai", "inu", "po",
        "ao", "mahina", "taua", "rua", "tahi", "tpu", "hue", "tua", "kau", "rau",
        "moko", "ura", "kaki", "hue", "pou", "uru", "tau", "pae", "aro", "tua",
        "tane", "wahine", "tama", "tuahine", "tungane", "matua", "tamahine", "mokopuna",
    ],
    "verb": [
        ...
        "rere", "huri", "taka", "ue", "nue", "haehae", "patu", "kohu", "tahu",
        "huti", "amo", "oho", "aue", "tangi", "hiamoe", "hiamoe", "araara",
        "tangi", "aroha", "riri", "haka", "tango", "tuku", "whaka", "hopu",
        "tango", "huri", "peke", "oma", "taki", "whaka", "hapa", "whiti",
    ],
    "num": [
        "tahi", "rua", "toru", "ha", "rima", "ono", "hitu", "va", "iva",
        "hongahuru", "tekau", "ruatekau", "toruteke", "hateke", "rimateke",
        "tahi_tekau", "rua_tekau", "toru_tekau", "ha_tekau", "rima_tekau",
        "rima_rau", "tahi_manu", "tahi_pou", "tahi_moana",
    ],
    "name": [
        "Hotu", "Matua", "Tuu", "Koihu", "Ngaara", "Tangaroa", "Makemake",
        "Tane", "Rongo", "Tiki", "Hina", "Papa", "Rangi", "Maui", "Tupa",
        "Kava", "Ure", "Ana", "Riri", "Koro", "Ariki", "Ika", "Mana",
        "Tane", "Rua", "Kena", "Pua", "Hura", "Tiki", "Tane",
        "Atua", "Mata", "Riri", "Tane", "Hina", "Pou", "Kura", "Moko",
    ],
    "part": [
        "i", "ki", "mai", "atu", "ma", "mo", "na", "no", "pe", "a", "o",
        "ei", "ana", "ra", "nei", "na", "ai", "ana", "ra", "hoi", "to",
        "ta", "to", "taa", "toa", "ia", "tae", "ake", "hoki", "tonu",
        "ano", "rawa", "koa", "hoki", "ake", "atu", "mai", "tahi",
    ],
}
...
def sample_glyph_for_word(word, category, position, sentence_len, prev_word, next_word, rng):
...
def generate(n_pairs=200000, seed=42, output="data/raw/lost_language/parallel_rongorongo_massive_v3.csv"):
    global _glyph_cache
    _glyph_cache = {}
    ...
    print(f"  Source mean: {df['source_len'].mean():.2f}, Target mean: {df['target_len'].mean():.2f}")
    print(f"  Unique source tokens: {len(set(t for s in df['source_text'] for t in s.split()))}")
    print(f"  Unique target glyphs: {len(set(t for s in df['target_glyphs'] for t in s.split()))}")
    return df
...
def main():
    ...
    parser.add_argument("--output", default="data/raw/lost_language/parallel_rongorongo_massive_v3.csv")
