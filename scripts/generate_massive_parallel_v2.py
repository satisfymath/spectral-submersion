...
def generate(n_pairs=100000, seed=42, output="data/raw/lost_language/parallel_rongorongo_massive_v2.csv"):
...
def main():
    ...
    parser.add_argument("--output", default="data/raw/lost_language/parallel_rongorongo_massive_v2.csv")
